					...
					<ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="${pageContext.request.contextPath}/CookieDeletionServlet">Đăng xuất</a>
							</div></li>
					</ul>
				</div>
			</nav>
									...
									<div class="job-group">
										<div class="job pagi">
											<div class="job-content">
												...
												<div class="job-desc">
													<div class="job-title">
														<a href="<c:url value="/JobDetailServlet?job_id=${job.job_id }&username=${name}"/>">${job.title}</a>
													</div>
													<div class="job-company">
														<a >${job.employer_name }</a> | <a 
												...
												<div class="wrap-btn-appl">
													<form action="<c:url value="/ApplyServlet"/>" method="get">
														...
														<input class="btn btn-success" type="submit" value="Ứng tuyển ngay" />
													</form>
												</div>
											</div>
										</div>
