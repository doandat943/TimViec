					...
					<ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="login.jsp">Đăng
									nhập</a> <a class="dropdown-item" href="DeleteCookieServlet">Đăng
									xuất</a>
							</div></li>
					</ul>
				</div>
								...
								<c:forEach var="job" items="${joblist }">
									<div class="item job-latest-item">
										<a class="job-latest-group"
											href="JobDetailServlet?job_id=${job.job_id }&user=NONE">
											<div class="job-lt-logo">
												<img src="img/${job.image }">
											</div>
											<div class="job-lt-info">
												<h3>${job.title }</h3>
												<a class="company">${job.employer_name}</a>
												<p class="address">
