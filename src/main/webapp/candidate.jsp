					...
					<ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="${pageContext.request.contextPath}/EmployerServlet">Dashboard</a> 
								<a class="dropdown-item" href="${pageContext.request.contextPath}/DeleteCookieServlet">Đăng xuất</a>
							</div></li>
					</ul>
				</div>
			</nav>
										...
										<div class="job pagi">
											<div class="job-content">
												...
												<div class="job-desc">
													...
													<div class="job-company">
														<a href="file_cv/${profileCV.file_cv }" style="color:blue"
														download='${fn:substring(profileCV.file_cv, 0, fn:indexOf(profileCV.file_cv, "\\.")) }'>
        												<img src="img/download-file.png" alt="File Icon">Tải CV</a>
													</div>
												</div>
											</div>
										</div>
