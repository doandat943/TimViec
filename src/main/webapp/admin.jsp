	...
	<div class="container-fluid fluid-nav">
		<div class="container cnt-tnar">
			<nav class="navbar navbar-expand-lg navbar-light bg-light tjnav-bar">
				...
				<a href="${pageContext.request.contextPath}/JobListServlet" class="nav-logo"> <img src="resources/img/fast-logo.png">
				</a>
									...
									<div class="job-group">
										<div class="job pagi">
											<div class="job-content">
												...
												<div class="job-desc">
													<div class="job-title">
														<a href="<c:url value="/JobDetailServlet?job_id=${job.job_id }&user=ADMIN"/>">${job.title }</a>
													</div>
	...
	<footer class="container-fluid copyright-wrap">
		<div class="container copyright">
			<p class="copyright-content">
				Copyright © 2023 <a href="#"> FastJob</a>. All Right
				Reserved.
			</p>
		</div>
	</footer>
