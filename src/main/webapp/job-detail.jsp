				...
				<div class="w-login m-auto">
					<div class="login-logo">
						<h3>
							...
							<a href="${pageContext.request.contextPath}/JobListServlet"> <img
								src="img/fast-logo.png" alt="FastJobs">
							</a>
						</h3>
										...
										<c:choose>
											<c:when test="${not empty user }">
												<c:if test="${user eq USER}">
													<form action="apply.jsp?jobID=${job.job_id }" method="get">
