		...
		<div class="container cnt-tnar">
			<nav class="navbar navbar-expand-lg navbar-light bg-light tjnav-bar">
				...
				<a href="${pageContext.request.contextPath}/JobListServlet"
					class="nav-logo"> <img src="img/fast-logo.png">
				</a>
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item"
									href="${pageContext.request.contextPath}/JobListServlet">Dashboard</a>
								<a class="dropdown-item"
	...
	<div class="container-fluid search-fluid">
        ...
        <c:choose>
            ...
            <c:when test="${cookie.role.value eq 'Admin'}">
                <li class="nav-item search-nav-item"><a class="nav-link" href="ManageAccountServlet">Quản trị</a></li>
            </c:when>
        </c:choose>
					...
					<div class="job-board-wrap">
						<div class="job-content">
							...
							<div class="wrap-btn-appl">
								<form action="<c:url value="/RecruitmentServlet"/>" method="get">
										...
										<div class="job pagi">
											<div class="job-content">
												...
												<div class="job-desc">
													...
													<div>
														<form action="DeleteJobServlet?job_id=${job.job_id }"
															method="post">
	...
	<footer class="container-fluid copyright-wrap">
		<div class="container copyright">
			<p class="copyright-content">
				Copyright © 2023 <a href="#"> Fast<b>Job</b></a>. All Right
				Reserved.
			</p>
		</div>
	</footer>
